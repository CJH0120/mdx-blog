---
title: Essential CS Knowledge Roadmap for Software Developers
description: An overview of essential Computer Science (CS) knowledge for software developers(frontend, backend, fullstack) and engineers, categorized into various areas.
date: 2024.9.9
